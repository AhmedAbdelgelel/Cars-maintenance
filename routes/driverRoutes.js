...
router
  .route("/")
  .get(protect, restrictTo("admin"), getAllDrivers); 
...
router.route("/phone/:phoneNumber").get(protect, restrictTo("admin"), getDriverByPhoneNumber);

router.route("/:id/maintenance").get(protect, restrictTo("admin", "driver"), getDriverMaintenanceRecords);
